...
client = MultiServerMCPClient(
    {
        ...
        "aviationstack": {
            "transport": "stdio",
            "command": r"C:\generative_ai_palylist\Trip-agent\aviationstack-mcp\.venv\Scripts\python.exe",
            "args": [
                "-m",
                "aviationstack_mcp",
                "mcp",
        ...
        "weather": {
            "transport": "stdio",
            "command": r"C:\generative_ai_palylist\Trip-agent\agentenv\Scripts\python.exe",
            "args": [
                r"C:\generative_ai_palylist\Trip-agent\custom_weather_mcp_server.py"
            ],
            "env": {
